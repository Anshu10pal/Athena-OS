/** Segmented arc gauge (cockpit-style) for 0-100 metrics. */
  ...
  return (
    <div className="flex flex-col items-center gap-1" title={`${label}: ${value}`}>
      <svg width={size} height={size * 0.78} viewBox="0 0 80 62" role="img" aria-label={`${label} ${value} out of 100`}>
        <path d="M 11.7 56.7 A 30 30 0 1 1 68.3 56.7" fill="none" stroke="#222938" strokeWidth="5" strokeLinecap="round" />
        <path
        ...
        />
        <text x="40" y="44" textAnchor="middle" fontSize="16" fill="#E8EBF1" fontFamily="JetBrains Mono, monospace">
          {value}
        </text>
      </svg>
